        ...
        <header className={`header ${mobileMenu ? "mobileView" : ""} ${show}`}>
            <ContentWrapper>
              ...
              {allReadyUser?(
               ...
               {currentUser?.Role==1?(<div style={{display:"flex",alignItems:"center",gap:"1rem"}} className="headerName" onClick={() => navigate("/profile")}><span><img style={{height:"30px",width:"30px",borderRadius:"15px"}} src={currentUser?.displayPicture?currentUser?.displayPicture:"https://firebasestorage.googleapis.com/v0/b/screenshare-1c657.appspot.com/o/1706451145400avatar-3814049_1280.jpg?alt=media&token=08fc954a-5fec-48e4-90fe-2a7e125e8b33"} alt="" /></span><span>{currentUser?.username}</span></div>):("")}
               {currentUser?.Role==4?(<div style={{display:"flex",alignItems:"center",gap:"1rem"}} className="headerName" onClick={() => navigate("/adminHome")}><span><img style={{height:"30px",width:"30px",borderRadius:"15px"}} src={currentUser?.displayPicture?currentUser?.displayPicture:"https://firebasestorage.googleapis.com/v0/b/screenshare-1c657.appspot.com/o/1706451145400avatar-3814049_1280.jpg?alt=media&token=08fc954a-5fec-48e4-90fe-2a7e125e8b33"} alt="" /></span><span>{currentUser?.adminName}</span></div>):("")}
                </div>):("")}
