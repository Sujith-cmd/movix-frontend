       ...
       <div className='facilityList' key={index}>
        ...
        <p>{e.featureDescription}</p>
         ...
         {/* <IoIosCloseCircleOutline style={{color:"white",fontSize:"40"}} onClick={()=>removeEatings(e._id,currentUser?._id)}/> */}
          ...
          <button type='button' onClick={addFacility}  style={{backgroundColor:"orange",borderRadius:"10px",fontWeight:"600",color:"black",height:"30px",width:"100px",cursor:"pointer"}}>Add facility</button>
          </form>
      </div>
      ...
      <div className='facility'>
       ...
       <div className='facilityList' key={index}>
        ...
        <IoIosCloseCircleOutline style={{color:"white",fontSize:"80"}} onClick={()=>removeEatings(e._id,currentUser?._id)}/>
          ...
          <button type='button' onClick={addEatables}  style={{backgroundColor:"orange",color:"black",height:"30px",borderRadius:"10px",fontWeight:"600",width:"100px",cursor:"pointer"}}>Add Eatables</button>
          </form>
      </div>
